...
String language_url[]={"IncomingCallHindi_UnRegistered.jsp?event=NewCall&Responsetype="+dataresponse+"&language="+"1"+"&groups_id="+groups_id+"&register_number="+register_number,"IncomingCallMarathi_UnRegistered.jsp?event=NewCall&Responsetype="+dataresponse+"&language="+"2"+"&groups_id="+groups_id+"&register_number="+register_number,"IncomingCallEnglish_UnRegistered.jsp?event=NewCall&Responsetype="+dataresponse+"&language="+"3"+"&groups_id="+groups_id+"&register_number="+register_number};
...
<c:choose> 
    <c:when test='${param.event == "NewCall" }'> 
        ...
        int length_cid=register_number.length();
        ...
        languageResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"MenuLanguage_UnRegistered.jsp?language="+language+"&groups_id="+groups_id+"&register_number="+register_number);
   ...
   try{
       ...
       if(language_value.equals("")||language_value.equals(null)||language_value==""||language_value==null){
       	   ...
       	   languageResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"MenuLanguage_UnRegistered.jsp?language="+language+"&groups_id="+groups_id+"&register_number="+registered_number);       
       }
    	  ...
    	  System.out.println("end");
      	  languageResponse.addPlayAudio(ConfigParams.DEFAULTWAV+"/default_wav/en_provide_valid_input.wav");
    	  languageResponse .addGotoNEXTURL(ConfigParams.getIvrslink()+"MenuLanguage_UnRegistered.jsp?event=NewCall&language="+language+"&register_number="+registered_number+"&groups_id="+groups_id);
      }
       out.print(languageResponse .getXML());
   }
   catch(Exception e){
