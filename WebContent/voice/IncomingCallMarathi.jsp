...
<c:choose> 
    ...
    // only for one response  
        ...
        // more then one response
            ...
            responsetype_response.addGotoNEXTURL(ConfigParams.getIvrslink()+"IncomingCallMarathi.jsp?Responsetype="+responsetype+"&language="+language+"&groups_id="+groups_id);
            out.print(responsetype_response.getXML());
   ...
   try{
       ...
       if(usernumber.equals(null)||usernumber.equals("")||usernumber==""||usernumber==null){
    	   ...
    	   responsetype_response.addGotoNEXTURL(ConfigParams.getIvrslink()+"IncomingCallMarathi.jsp?event=NewCall&Responsetype="+responsetype+"&language="+language+"&groups_id="+groups_id);
