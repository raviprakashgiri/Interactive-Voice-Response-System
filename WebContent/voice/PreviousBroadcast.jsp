...
<c:choose> 
    <c:when test='${param.event == "NewCall" }'> 
        ...
        <%
                ...
                kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PreviousBroadcast.jsp?groups_id="+group_id+"&caller_id="+caller_id);
        ...
        <%   
         ...
         try{
           ...
           if(language.equals(null)||language.equals("")||language==""||language==null){
        	   ...
        	   kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PreviousBroadcast.jsp?event=NewCall&language="+language);
        	   
           }
           else if(language.equals("1")){
        	    kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PreviousNextBroadcast.jsp?event=NewCall&caller_id="+callerID);
               }
