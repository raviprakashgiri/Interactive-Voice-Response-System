...
<c:choose>
    ...
    audioResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PreviousRepeatBroadcastMessage.jsp?groups_id="+groups_id+"&caller_id="+caller_id); 
        ...
        <%   
         ...
         try{
           ...
           if(language.equals(null)||language.equals("")||language==""||language==null){
        	   ...
        	   kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PreviousBroadcast.jsp?event=NewCall&caller_id="+callerID+"&groups_id="+Groups_id);
        	   ...
        	   IvrsUtilityFunctions call = new IvrsUtilityFunctions();
	            ...
	            // get the group according to latest broadcast message 
              	...
              	if(broadcastMessage.equals("No broadcast message"))
              	{
                 		kResponse.addPlayText(broadcastMessage);
                   		kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PBMessage.jsp?event=NewCall&groups_id="+Groups_id+"&caller_id="+callerID);
              	}
              	else{
