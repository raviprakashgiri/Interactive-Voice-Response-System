    ...
    <c:when test='${param.event == "NewCall" }'> 
     ...
     // only for one language
        ...
        // for more then one language
            ...
            responsetype_response.addGotoNEXTURL(ConfigParams.getIvrslink()+"Publisher_English.jsp?Responsetype="+responsetype+"&language="+language+"&groups_id="+groups_id);
            out.print(responsetype_response.getXML());
   ...
   try{
	 ...
	 //interpreting the selected option
	   if(usernumber.equals(null)||usernumber.equals("")||usernumber==""||usernumber==null){
		   ...
		   responsetype_response.addGotoNEXTURL(ConfigParams.getIvrslink()+"Publisher_English.jsp?event=NewCall&Responsetype="+responsetype+"&language="+language+"&groups_id="+groups_id);
	   }
