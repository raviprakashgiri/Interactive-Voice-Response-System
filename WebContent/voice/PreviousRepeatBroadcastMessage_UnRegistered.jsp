...
<c:choose>
    ...
    audioResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PreviousRepeatBroadcastMessage_UnRegistered.jsp?groups_id="+groups_id+"&caller_id="+caller_id+"&register_number="+register_number); 
        ...
        <%   
         ...
         try{
           ...
           if(language.equals(null)||language.equals("")||language==""||language==null){
        	   ...
        	   kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"PreviousBroadcast_UnRegistered.jsp?event=NewCall&caller_id="+callerID+"&groups_id="+Groups_id+"&register_number="+registered_number);
