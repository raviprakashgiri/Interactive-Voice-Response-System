...
<c:choose> 
    <c:when test='${param.event == "NewCall" }'> 
        ...
        // for more then one response
            ...
            responsetype_response.addGotoNEXTURL(ConfigParams.getIvrslink()+"Publisher_Marathi.jsp?Responsetype="+responsetype+"&language="+language+"&groups_id="+groups_id);
            out.print(responsetype_response.getXML());
   ...
   try{
     ...
     //interpreting the selected option
       if(usernumber.equals(null)||usernumber.equals("")||usernumber==""||usernumber==null){
    	   ...
    	   responsetype_response.addGotoNEXTURL(ConfigParams.getIvrslink()+"Publisher_Marathi.jsp?event=NewCall&Responsetype="+responsetype+"&language="+language+"&groups_id="+groups_id);
