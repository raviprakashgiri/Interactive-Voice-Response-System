...
<c:choose> 
    <c:when test='${param.event == "NewCall" }'> 
        ...
        <%
                ...
                kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"LanguageMenu.jsp?groups_id="+groups_id);
        ...
        <%   
         ...
         try{
           ...
           if(language.equals(null)||language.equals("")||language==""||language==null){
        	   ...
        	   kResponse.addGotoNEXTURL(ConfigParams.getIvrslink()+"LanguageMenu.jsp?event=NewCall&language="+language);
