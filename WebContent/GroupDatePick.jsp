...
%>
	...
	<div id="groupDatePicker" >
		...
		<tr>
			...
			<tr>
	<td><input type="submit" value="Submit" style="background-color:cadetblue"><input type="hidden" value="groupOrderSummary" name="req_type"></td>
			</tr>
