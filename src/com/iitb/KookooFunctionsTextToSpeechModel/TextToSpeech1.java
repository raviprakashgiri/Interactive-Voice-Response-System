...
public class TextToSpeech1 {
	...
	public String convertText(String language, byte[] textToConvert, String filePath, String fileName) throws UnsupportedEncodingException{
		...
		DhvaniTTS(language, new String(textToConvert,"UTF-8"), filePath, fileName);
		
		System.out.println(timeStamp + " TTS exit");
		return "Done";
	}
	
public String max(String language, byte[] textToConvert, String filePath, String fileName) throws UnsupportedEncodingException{
...
/*	public String max( String l, byte[] textToConvert, String n ,String o) {
	    ...
	    BufferedReader es = null;
		  try{
	  	 ProcessBuilder pb = new ProcessBuilder("bash","/home/hduser/ruralivrs/TTS/newfest.sh",l,m,n,o);
	  	Process p = pb.start();
	...
	*/
	...
	private void DhvaniTTS(String l, String m, String n, String o){
		 try{
